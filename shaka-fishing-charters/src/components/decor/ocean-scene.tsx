  ...
  return (
    <div className={`absolute inset-0 overflow-hidden ${className}`} aria-hidden="true">
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, #062033 0%, #0c4a6e 32%, #0e7490 58%, #14a5c9 78%, #38bdf8 100%)",
        }}
      />
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(251,146,60,0.9) 0%, rgba(251,146,60,0.25) 45%, rgba(251,146,60,0) 70%)",
        }}
